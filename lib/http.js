...
exports.listen = function (options, transportUtil) {
  return function (msg, callback) {
    ...
    if(listenOptions.protocol === 'https'){
      var key = fs.readFileSync(listenOptions.serverOptions.keyPemPath);
      var cert = fs.readFileSync(listenOptions.serverOptions.certPemPath);
      var httpsOptions = {
          key: key,
          cert: cert,
      };
